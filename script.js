...
const levels = [
    ...
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L2 - Кликбејт стапици", question: "Наслов на портал вели: 'НЕМА ДА ВЕРУВАТЕ ШТО СЕ СЛУЧИ И ВЧЕРА ВО СКОПЈЕ! (ВИДЕО)'. Ова е:", answers: ["Сериозно истражување", "Кликбејт (Clickbait) создаден само за кликови и заработка од реклами", "Официјално соопштение"], correct: 1, achievement: "🎣 Избегнувач на јадици" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L3 - Ера на емоции", question: "Луѓето масовно споделуваат лажна вест за некоја позната личност само затоа што емотивно им се допаѓа, иако има докази дека е лага. Живееме во ера на:", answers: ["Целосна вистина", "Пост-вистина (каде емоциите се поважни од објективните факти)", "Крај на интернетот"], correct: 1, achievement: "👁️ Сидро на реалноста" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L4 - Жолт печат", question: "Кои теми најчесто доминираат во т.н. 'жолт печат' и таблоидни портали?", answers: ["Економски анализи за инфлацијата", "Трачеви, приватниот живот на познатите, сензационализам и шокантни наслови", "Научни откритија"], correct: 1, achievement: "🟡 Анти-Таблоид агент" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L5 - Моќта на парите", question: "Според Ноам Чомски, од што најмногу зависи независноста на приватните големи медиуми?", answers: ["Од желбата на новинарот", "Од парите на моќните огласувачи кои плаќаат скапи реклами", "Од бројот на лајкови"], correct: 1, achievement: "📖 Чомски аналитичар" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L6 - Претерување", question: "Паднал мал пролетен дожд во Скопје, а некој портал става наслов: 'АПОКАЛИПСА И КАТАСТРОФА ГО ПОГОДИ ГРАДОТ!'. Ова е пример за:", answers: ["Сензационализам", "Објективно известување", "Длабока научна анализа"], correct: 0, achievement: "📢 Смирувач на паника" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L7 - Врамување", question: "Два медиуми известуваат за ист протест. Едниот вели 'Хероите бараат права', а другиот 'Хулиганите прават хаос'. Ова е:", answers: ["Врамување (Framing - ставање на веста во различен ментален контекст)", "Случајна грешка во текстот", "Плурализам"], correct: 0, achievement: "🖼️ Декодер на рамки" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L8 - Лажни граѓани", question: "Некоја фирма отвора 500 лажни Фејсбук профили (ботови) за да пишуваат коментари дека нивната кампања е супер. Оваа појава се вика:", answers: ["Садење трева", "Astroturfing (вештачко креирање лажна слика дека зад нешто стои реално граѓанско движење)", "Хакирање сајтови"], correct: 1, achievement: "🌱 Разоткривач на ботови" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L9 - Напад на личност", question: "Наместо да дебатира со факти, некој медиум почнува да објавува приватни слики од професорот за да го посрамоти и да му го уништи угледот. Тоа е:", answers: ["Карактерен атентат (Character Assassination)", "Правна заштита", "Физички напад"], correct: 0, achievement: "⚔️ Штит на честа" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L10 - Точно но лажно", question: "Кога една информација содржи точни факти но тие се намерно извртени и изменети за да те заведат на погрешен заклучок, тоа е:", answers: ["Целосна лага", "Полувистина", "Апсолутна вистина"], correct: 1, achievement: "🌓 Детектор на полувистини" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L11 - Гаслајтинг", question: "Твојот омилен портал упорно ти тврди со денови дека нешто не се случило, иако ти самиот си го видел со свои очи, па почнуваш да се сомневаш во својот разум. Ова е:", answers: ["Медиумски Гаслајтинг (Gaslighting)", "Прајминг", "Gatekeeping"], correct: 0, achievement: "🕯️ Гасач на лажни светилки" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L12 - Нема трета опција", question: "Кога некој медиум во дебата ти нуди само две екстремни решенија (Или си со нас, или си против нас!), игнорирајќи го средниот разумен пат, прави:", answers: ["Лажна дихотомија", "Објективен избор", "Плурализам"], correct: 0, achievement: "⚖️ Чувар на логиката" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L13 - Извадено од контекст", question: "Некој исекол само 3 секунди од видео на Јутјубер за да изгледа дека тој навредува некого, а го тргнал целото претходно објаснување. Ова е:", answers: ["Деконтекстуализација (Вадење од контекст)", "Врамување", "Проверка на факти"], correct: 0, achievement: "🧩 Враќач на контекстот" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L14 - Инфотејнмент", question: "Вестите на една ТВ повеќе личат на забавно шоу со смешни видеа, естрада и трачеви отколку на сериозни информации. Ова се нарекува:", answers: ["Научна програма", "Инфотејнмент (Infotainment - спој на вести и забава заради комерцијален профит)", "Државен извештај"], correct: 1, achievement: "🎬 Медиумски критичар" },
    { chapterId: 2, chapterName: "Поглавје 2: Фабрикување вести и медиумски спин", title: "L15 - Ширење страв", question: "Порталите секој ден објавуваат панични наслови: 'НОВ ОПАСЕН ВИРУС СТИГНА, КУПЕТЕ ГИ ОВИЕ АПЧИЊА ВЕДНАШ!'. Оваа стратегија се вика:", answers: ["Fearmongering (Намерно ширење страв и паника за контрола и профит)", "Култивација", "Агенда сетинг"], correct: 0, achievement: "🛡️ Ум без страв" },
